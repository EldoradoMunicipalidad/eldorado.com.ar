...
export default function TurneroAmbienteAdminPage() {
  const [tab, setTab] = useState('areas')
  const [isAuthenticated, setIsAuthenticated] = useState(() => sessionStorage.getItem('ambiente_admin_auth') === 'true')
  ...
  const handleLogin = async (e) => {
    ...
    if (ok) {
      sessionStorage.setItem('ambiente_admin_auth', 'true')
  ...
  const handleLogout = () => {
    sessionStorage.removeItem('ambiente_admin_auth')
  ...
  return (
    <>
      <SectionLayout
        ...
        description="Gestioná las áreas, configurá días y horarios, y revisá los turnos solicitados para la Dirección de Ambiente."
      >
