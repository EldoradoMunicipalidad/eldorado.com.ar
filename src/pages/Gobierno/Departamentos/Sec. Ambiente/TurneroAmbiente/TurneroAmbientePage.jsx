...
export default function TurneroAmbientePage() {
    ...
    return (
      <>
        <SectionLayout
          title="Sistema de"
          highlight="Turnos"
          description="Reservá tu turno para trámites de la Dirección de Ambiente."
        />
        <Section>
          <div className="max-w-lg mx-auto text-center">
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8 shadow-sm">
              ...
              <button
                onClick={() => navigate('/gobierno/secretaria-de-ambiente/ambiente')}
        ...
        <Section>
          <div className="max-w-2xl mx-auto">
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm text-center">
              ...
              <p className="text-slate-500 mb-6">Presentate en la Dirección de Ambiente</p>
  ...
  return (
    <>
      <SectionLayout
        title="Sistema de"
        highlight="Turnos"
        description="Reservá tu turno para trámites de la Dirección de Ambiente. Podés solicitar hasta 3 turnos por día de áreas distintas."
      >
