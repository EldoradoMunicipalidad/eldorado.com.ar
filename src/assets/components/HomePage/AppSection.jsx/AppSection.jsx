            ...
            <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-14">
                ...
                <div className="flex-1 space-y-8 text-center lg:text-left">
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-start gap-3 pt-2">
                        <a
                            href="https://apps.apple.com/us/app/mimunimicuenta/6747196607"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex items-center gap-3 px-5 py-3 rounded-xl bg-slate-900 text-white hover:bg-slate-800 transition shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                        >
                        ...
                        <a
                            href="https://play.google.com/store/apps/details?id=programconsultoressa.pgmtools.app&hl=es_419"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex items-center gap-3 px-5 py-3 rounded-xl bg-slate-900 text-white hover:bg-slate-800 transition shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                        >
