...
export const TramitesAndServiciosSection = ({ dynamicItems }) => {
  const staticItems = [
    { id: 1, Icon: Icons.TributarioIcon, title: "Portal Tributario", subtitle: "Consultá y aboná tus tasas municipales en línea", to: "https://www.municipalidad.com/eldo/home/menu" },
    { id: 2, Icon: Icons.ComercialIcon, title: "Preinscripción Comercial", subtitle: "Iniciá la habilitación comercial de tu emprendimiento", to: "/ciudadano-digital/preinscripcion-comercial" },
    { id: 3, Icon: Icons.LicenciasIcon, title: "Licencias de Conducir", subtitle: "Solicitá turnos e información para tu licencia", to: "/gobierno/secretaria-gobierno/transito-y-transporte/centro-emision-licencias" },
    ...
    { id: 11, Icon: Icons.JuzgadoIcon, title: "Juzgado de Faltas", subtitle: "Consultá trámites, actas y gestiones del juzgado", to: "/gobierno/juzgado-de-faltas" },
    { id: 12, Icon: Icons.BoletinIcon, title: "Boletín Oficial", subtitle: "Accedé a publicaciones y normativa municipal actualizada", to: "/gobierno-abierto/boletin-oficial" }
  ]
  const itemsData = dynamicItems || staticItems
