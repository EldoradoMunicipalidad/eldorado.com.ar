...
const DirMantenimientoAndServiciosIcon = (props) => {
    return (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
...
export default DirMantenimientoAndServiciosIcon